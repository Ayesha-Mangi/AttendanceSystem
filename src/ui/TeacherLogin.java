...
public class TeacherLogin {
    public TeacherLogin() {
        ...
        loginButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                int teacherId = authenticateTeacher(username, password);
                if (teacherId != -1) {
    ...
    public int authenticateTeacher(String username, String password) {
        ...
        try {
            ...
            String query = "SELECT id FROM teachers WHERE name = ? AND password = ?";
